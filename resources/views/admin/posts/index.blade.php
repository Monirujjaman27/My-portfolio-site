                                ...
                                <tbody>
                                    ...
                                    @foreach( $allpost as $allpost)
                                        ...
                                        <tr class="dataRow{{ $allpost->id }}" data-id="{{ $allpost->id }}">
                                            ...
                                            <td>{{ ucfirst(strip_tags(Str::limit($allpost->description, 20))) }}</td>
                                            ...
                                            <td> @if(isset($allpost->user->name)) {{ ucfirst($allpost->user->name) }} @else {{ 'unknown' }} @endif</span></td>
                                            <td class="d-flex">
                                                ...
                                                <button data-toggle="tooltip" title="Click To delete The Post" 
                                                 type="submit" class="btn badge badge-danger delpostteBtn ml-1">
                                                    Delete</button>
                                            </td>
                                        </tr>
