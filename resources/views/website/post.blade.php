...
<div class="site-cover site-cover-sm same-height overlay single-page"
    style="background-image: url('{{ asset('public/storage/post') }}/{{ $post->image }}'); background-size: 700px;
    background-repeat: no-repeat;">
    <div class="container">
        <div class="row same-height justify-content-center">
            <div class="col-md-12 col-lg-10">
                <div class="post-entry text-center">
                    <span class="post-category text-white bg-success mb-3">@if(isset($post->category->name)){{ ucfirst($post->category->name) }} @else{{ 'No category' }} @endif </span>
                    ...
                    <div class="post-meta align-items-center text-center">
                        ...
                        <span class="d-inline-block mt-1">By  @if(isset($post->user->name)) {{ ucfirst($post->user->name) }} @else {{ 'unknown' }} @endif</span>
            ...
            <div class="col-md-12 col-lg-8 main-content">
                ...
                <div class="pt-5">
                    <p><strong class="font-weight-bold" for="">Categories:</strong> <a
                            href="{{ route('website.category', ['slug'=>$post->slug]) }}">
            ...
            <div class="col-md-12 col-lg-4 sidebar">
                ...
                <div class="sidebar-box">
                    <div class="bio text-center">
                        <img src="@if( isset($post->user->image) ) {{ asset('public/storage/user').'/'.$post->user->image }} @else{{ asset('public/storage/logo/user.svg') }} @endif"
                            alt="{{ $post->user->image }}" class="img-fluid mb-5">
                        <div class="bio-body">
                            <h2> @if(isset($post->user->name)) {{ ucfirst($post->user->name) }} @else {{ 'unknown' }} @endif</h2>
                ...
                <div class="sidebar-box">
                    ...
                    <ul class="categories">
                        ...
                        <li><a href="{{ route('website.category', ['slug'=>$allcategory->slug]) }}">
                        @if(isset($allcategory->name)){{ ucfirst($allcategory->name) }} @else{{ 'No category' }} @endif 
                                <span></span></a></li>
                        @endforeach
                    </ul>
                </div>
                    ...
                    <div class="excerpt">
                        ...
                        <div class="post-meta align-items-center text-left clearfix">
                            ...
                            <figure class="author-figure mb-0 mr-3 float-left"><img
                                    src="@if( isset($post->user->image) ) {{ asset('public/storage/user').'/'.$post->user->image }} @else{{ asset('website/images/user.svg') }} @endif"
                                    alt="@if( isset($post->user->image) ) {{ $post->user->image }} @else{{ asset('website/images/user.svg') }} @endif" class="img-fluid">
                            </figure>
