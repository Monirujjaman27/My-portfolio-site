...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('public/storage/logo') }}{{ '/'.$settings->logo }}" type="image/x-icon">
                ...
                <li class="ml-2 nav-item">
                    ...
                    <a href="{{ route('user.profile') }}">
                        <img height="30px" width="30px" class="rounded rounded-circle"
                            src="@if( isset(Auth::user()->image) ) {{ asset('public/storage/user').'/'.Auth::user()->image }} @else{{ asset('public/storage/logo/user.svg') }} @endif" alt="">
